...
type Doc = Tables<"documents"> & { properties: { name: string } | null };

// Document types a user files manually (photos are attached from work orders).
...
export default function Documents() {
  ...
  const [docType, setDocType] =
    useState<(typeof DOC_TYPES)[number]>("warranty");
    ...
    <Screen>
      ...
      <ScrollView contentContainerClassName="px-5 pb-10">
        {docs.length === 0 ? (
          <EmptyState
            title="No documents"
            subtitle="Store leases, warranties, receipts and manuals — tap to open any of them."
          />
        ) : (
          docs.map((d) => (
